...
public class GithubService {
    ...
    public  GithubService(GithubApi githubApi, RepositoryDao repositoryDao,ExecutorService executorService, Logger logger) {
    ...
    private List<RepositoryDbEntity> networkToDbEntities(String username, List<RepositoryNetworkEntity> entities) {
        return Stream.of(entities)
                .map(networkEntity -> new RepositoryDbEntity(username, networkEntity)).toList();
    }
